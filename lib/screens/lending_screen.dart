...
class LendingScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Friends & Lending', style: TextStyle(fontWeight: FontWeight.bold)),
      ),
      body: Column(children: [
        ...
        Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
            _summaryCol(
              'Total Owed to You',
              netBalance.values.where((v) => v > 0).fold(0.0, (a, b) => a + b),
              Colors.green.shade200,
            ),
            Container(width: 1, height: 40, color: Colors.white24),
            _summaryCol(
              'You Owe Others',
              netBalance.values.where((v) => v < 0).fold(0.0, (a, b) => a + b.abs()),
              Colors.red.shade200,
            ),
          ]),
        ),
          ...
          Expanded(
            child: Center(
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                const Text('No active lendings', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              ...
              children: netBalance.entries.map((entry) {
                ...
                return Card(
                  ...
                  child: ExpansionTile(
                    ...
                    subtitle: Text(
                      iOweThemMore
                          ? 'You owe ₹${NumberFormat('#,##0').format(net.abs())}'
                          : 'Owed to you ₹${NumberFormat('#,##0').format(net)}',
                      style: TextStyle(
                        color: iOweThemMore ? Colors.red : Colors.green,
                    ...
                    children: byFriend[name]!.map((l) => _lendingTile(context, ref, l)).toList(),
                  ),
                );
              }).toList(),
            ),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text('Record', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
      ),
    );
  }

  Widget _summaryCol(String label, double amount, Color valueColor) {
  ...
  Widget _lendingTile(BuildContext context, WidgetRef ref, Lending l) {
    return ListTile(
      dense: true,
      leading: Icon(
      ...
      title: Text(
        l.isIGave
            ? 'You gave ₹${NumberFormat('#,##0').format(l.amount)}'
            : 'You owe ₹${NumberFormat('#,##0').format(l.amount)}',
        style: TextStyle(
          fontWeight: FontWeight.w600,
          color: l.isIGave ? Colors.green : Colors.red,
          fontSize: 13,
...
class _AddLendingSheetState extends State<_AddLendingSheet> {
  ...
  bool _iGave = true; // true = I gave them money
    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 16),
          Text('Record Lending', style: theme.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
            ...
            Expanded(
              child: GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: _iGave ? Colors.green : theme.colorScheme.surfaceContainerHighest,
                  ...
                  child: Center(
                    child: Text(
                      ...
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        color: _iGave ? Colors.white : theme.colorScheme.onSurface,
                      ),
                    ),
                  ),
                ),
            ...
            Expanded(
              child: GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  padding: const EdgeInsets.symmetric(vertical: 12),
                  decoration: BoxDecoration(
                    color: !_iGave ? Colors.red : theme.colorScheme.surfaceContainerHighest,
